...
[![Deploy to GitHub Pages](https://github.com/ahonour/nft_dev/actions/workflows/deploy.yml/badge.svg)](https://github.com/ahonour/nft_dev/actions/workflows/deploy.yml)
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/ahonour/nft_dev.git
   cd nft_dev
   ```
...
2. Update your local repository
   ...
   ```bash
   git remote set-url origin https://github.com/ahonour/nft_dev.git
   ```
